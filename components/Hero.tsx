  ...
  return (
    <section id="hero" className="bg-gradient-to-r from-brand-blue to-brand-green-light text-white py-20 md:py-32">
      <div className="container mx-auto px-6 text-center">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4">Allowance Aid Lending Services: Build on Trust Provided by Us</h1>
        ...
        <button
          ...
          className="bg-white text-brand-blue font-bold py-3 px-8 rounded-full text-lg hover:bg-gray-200 transition duration-300 transform hover:scale-105"
        >
          Get Started
        </button>
      </div>
